...
void metodoISE(){
    ...
    calcularSegmentacionISE(serie, dominantes, errores, puntos);
...
void metodoEMax(){
    ...
    std::vector<long double> errores;
    std::vector<long double> dominantes;
    iniciarDominantesErrores(serie, dominantes, errores, 1);
    calcularSegmentacionEMax(serie, dominantes, errores, puntos);
    adjudicarDominantes(serie, dominantes);
