...
bool verificarProductoRepeticiones(const int repeticiones, const int orden, 
...
void mostrarSolucionMontecarlo(const bool correcto, const long double probabilidad, 
const long double tiempo_producto, const long double tiempo_verificacion){
    std::cout << std::endl;
    if(correcto){
        std::cout << "CORRECTO. La matriz C es el porducto de AB" << std::endl;
        ...
        std::cout << "FALSO. La matriz C no es el porducto de AB" << std::endl;
        std::cout << "Tiempo del producto: " << tiempo_producto/1000.0 << "ms" << std::endl;
        std::cout << "Tiempo de la verificación: " << tiempo_verificacion/1000.0 << "ms" << std::endl;          
    }
    std::cout << std::endl;
